...
\subsection{Informal Statement of Result}
  ...
  \begin{figure}[h!]
    ...
    \caption{%
        Diagrams evaluate to tensor expressions (\!\!\protect\ofthree{01}): a
        ...
        class of histories; \!\!\protect\ofthree{2} shows an example history
...
\begin{figure}%{r}{0.3\textwidth}
    ...
    %\plotmooh{aaai/helix-blueprint}{}{0.18\textwidth}
