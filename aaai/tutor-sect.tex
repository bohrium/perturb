    ...
    \begin{landscape}
        ...
        of those diagrams in page \ref{sect:gridss}'s grid.
        %
    ...
    \begin{landscape}
        \subsubsection{Computations: Evaluating each diagram history}\label{sect:example-eval}
            We evaluate page \pageref{sect:exampleembed}'s diagrams.  We choose here to
        ...
        \begin{tabular}{p{0.48\linewidth}p{0.48\linewidth}}
            \textsc{Effect of Gradients (Question \ref{qst:grad})}&\textsc{Effect of Epochs (Question \ref{qst:multi})}\\
            \hline
            In page \pageref{sect:exampleembed} we determined the histories of
            ...
            $$
          &
            In page \pageref{sect:exampleembed} we saw that
    ...
    \begin{landscape}
        ...
        \par\indent$\bullet$ we sum page \pageref{sect:example-eval}'s uvalues, each weighted by the number of ways its diagram
        embeds in the grid,
        \par\indent$\bullet$ where histories with $s$ many symmetries count only $1/s$ much
        toward the total number of histories.
        \par\noindent
        A symmetry of a history $f$
        ...
        \begin{tabular}{p{0.48\linewidth}p{0.48\linewidth}}
            \textsc{Effect of Gradients (Question \ref{qst:grad})}&\textsc{Effect of Epochs (Question \ref{qst:multi})}\\
            \hline
            Referring again to page \pageref{sect:exampleembed}, we see that
    ...
    \subsection{How to identify the relevant diagram histories}    \label{appendix:draw-histories}
        ...
        \begin{figure}[h] 
            ...
            \caption{
                ...
                \textbf{Middle}: a history of $\sdia{c(0-1-2)(01-12)}$.
                Also a history of $\sdia{c(01-2)(01-12)}$,
        ...
        \begin{rmk*}
            ...
            noise or multiple epochs.  In these situations, it is usually the case
            ...
            Likewise, in page \pageref{appendix:example} we argued by considering 
    ...
    \subsection{How to evaluate each history}                     \label{appendix:evaluate-histories}
        ...
        \noindent
        \translucent{moolime}{\parbox{\textwidth}{
            \textsc{Turn a history of a diagram} into its uvalue or rvalue
        ...
        \subsubsection{Un-resummed values: $\uvalue(D)$}
            ...
            $C=\ex{(\nb\lx - G)^2}$.
            %For technical reasons (page \pageref{appendix:mobius} and
            %page \pageref{appendix:resum}),
            Because cumulants aid mobius inversion,
            cumulants will be easier to work with than
            ...
            \begin{exm}
                ...
                \end{align*}
                We will use the concept of ``moment values'' again when discussing Theorem \ref{thm:pathint}.
            }
                \mend
            \end{exm}
        ...
        \subsubsection{Resummed values: $\rvalue_f(D)$}
            ...
            \begin{exm}[Re-summed value] \label{exm:resum}
                ...
                $
                    ...
                    = C_{\mu\nu} H_{\lambda\rho}
                $.
                Then if $f$ is a history of $\mdia{c(01-2)(02-12)}$ that
        ...
        \subsubsection{Overall}
            In sum, we evaluate a history of a diagram by using the 
            \textbf{node}, 
            \textbf{outline}, and
            \textbf{edge}
    ...
    \subsection{How to sum the histories' values}                  \label{appendix:sum-histories}
        ...
        \begin{thm*}
            ...
            %We say a history is \emph{strict} if it assigns to each part
        ...
        An \textbf{automorphism of $D$ that preserves a history $f$ of $D$}
        ...
        \begin{exm}[Automorphisms]
            \emph{
                We take as examples the diagram histories reproduced below.  All the histories in the \textbf{left
    ...
    \subsection{How to solve variant problems}                      \label{appendix:solve-variants}
        In page \pageref{appendix:future}, we briefly discuss second-order methods
        and natural gradient descent.  Here, we briefly discuss modifications.
        We omit proofs, which would closely follow page \pageref{appendix:math}'s
    ...
    \subsection{Do diagrams streamline computation?}                \label{appendix:diagrams-streamline}
        ...
        descent by comparing direct perturbation\footnote{
            ...
            Lemma (page \pageref{appendix:key-lemma}).
        }
        ...
        \subsubsection{Effect of batch size}
            ...
            \begin{shaded}
                ...
                diagrams, $\sdia{c(01-2)(02-12)}$ and $\sdia{c(01-2)(01-12)}$.  The
                first diagram, $\sdia{c(01-2)(02-12)}$, embeds in GD's space time in
                $N^2$ as many ways as it embeds in SGD's spacetime, due to
                horizontal shifts.  Likewise, there are $N^2$ times as many
                histories of $\sdia{c(01-2)(02-12)}$ in distinct epochs of GD's
                spacetime as there are in distinct epochs of SGD's spacetime.
                However, each same-epoch history of $\sdia{c(01-2)(01-12)}$ within
                any one epoch of GD's spacetime corresponds by vertical shifts to
                a history of $\sdia{c(0-1-2)(01-12)}$ in SGD.  There are
