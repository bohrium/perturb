We explain the content of our main abstract
result: that diagram-based analysis is correct.
The appendices more thoroughly discuss proofs and examples.  
...
\subsection{Diagrams arise from and organize Taylor series}\label{sect:challenges}
  %Overall, a general summand in (the higher order analogue of) \translucent{moolime}{$X$} has the following form (evaluated at $\theta=\theta_0$):
  One may with effort explicitly differentiate a $T$th iteration of the SGD
  update  for a fixed sequence of batches. 
  A general summand in this series looks like (evaluated at $\theta=\theta_0$):
$$
...
%physical interpretation of SGD.
    ...
    \subsubsection{SGD as a Sum over Histories}\label{sect:histories}
            ...
            Thus, by construction we have represented terms in
            $\expc[l(\theta_T)]$'s Taylor expansion %(\ref{eq:dyson}) as
            uvalues of diagrams.
            What is the coefficient for each diagram?s
            uvalue simply counts the diagram's histories 
            Intuitively, a diagram represents a process and so the diagram's
            contribution scales with the number of ways that process may occur.
            Indeed, the Key Lemma (proved by induction on $T$; see Appendix)
            ...
            counter overcounting), where we have defined \emph{histories}
            above with
            ...
            %%diagrams are relevant.  Examples:
            %%%for fixed $T$, \textbf{to order
            ...
            \begin{figure}%{r}{0.2\linewidth}
                ...
                \plotmooh{aaai/resum-cubic-histories}{}{3.15cm}
                \plotmooh{aaai/resum-physics}{}{3.15cm}
                ...
                \caption{%
                  ...
                  %%shows one of a diagram's histories. 
                  ...
                  %in the absence of noise and inter-update
                  %interactions.
                }
