        ...
        \subsection{Notation and assumptions, II}\label{sect:background}
            ...
            \textsc{Tensors} --- We make heavy use of the %Figure \ref{fig:tensor}'s tensors;
            ...
            %Def.\ \ref{dfn:uvalue-body} explains how diagrams depict tensors.
            ...
            %\textsc{Vectors vs Covectors} --- 
                ...
                %%numerically \emph{increases} (to $2000$).  So
                Gradients
                ...
                %%(whose two axes transform like vectors).
                %
                \cite{mi73} (\S2.5) visualizes this geometry;
                %\cite{ko93} (\S7,14) pinpoints the sense in which to ignore this distinction is unnatural;
        ...
        \subsection{Diagrams overcome Taylor Series challenges}\label{sect:using}\label{sect:diagrams}
            ...
            \subsubsection{Embeddings depict concrete information-flow processes}\label{sect:histories}
            ...
            \begin{dfn}
                \emph{An \textbf{history} of a diagram is an assignment of non-root
