...
We introduce the Taylor series approach to studying SGD dynamics and then the
diagram notation for the terms that thus appear.  After showing how to
evaluate diagrams to numbers, we state our main result: that diagram-based
analysis is correct.
