...
\begin{document}
    ...
    \begin{abstract}
        %Popular continuous-time approximations of SGD
        %%stochastic gradient descent (SGD)
        %such as
        %%stochastic differential equations (SDE)
        %SDEs
        %assume independent Gaussian
        %gradient noise and thus fail to model the finite-sample effects that 
        %make generalization non-trivial.
        %
        %
        ...
        % gradient descent (SGD) by Taylor-expanding with respect to the
        % learning rate.  We present a new diagram-based technique that permits
        ...
        % entropic corrections to deterministic descent.  Our theory predicts
        % that gradient noise biases SGD's trajectory toward low-curvature,
        % low-noise regions of the loss landscape.  We contrast our theory
        % against popular approximations of SGD such as SDE and experimentally
        % verify our theory's predictions.
        %%%
        % We quantify how gradient noise shapes the dynamics of stochastic
