    \subsection{Assumptions and Definitions}                        \label{appendix:assumptions}
        ...
        \begin{dfn}[Embedding a Diagram into a Grid]
            An history of a diagram into a grid is an assignment of that
        ...
        \S\ref{appendix:evaluate-histories}.
    ...
    \subsection{From Dyson to diagrams}                             \label{appendix:toward-diagrams}
        ...
        \begin{thm}[Test Loss as a Path Integral] \label{thm:pathint}
            ...
            any fuzzy edge, $f$ is an history of $D$ into a grid, and
        ...
        Lemma by matching each term to an history of a diagram in a grid,
        ...
        \begin{proof}[Proof of Theorem \ref{thm:pathint}]
            ...
            \tilde D$.  The $(\beta, \nu)$-term corresponds to an history
    ...
    \subsection{Proof of Theorem \ref{thm:resum}}    \label{appendix:resum}
        ...
        (We say an history is \textbf{strict} if it assigns to each part
        a different datapoint $n$.
        Then, by M\"obius inversion (\cite{ro64}), a sum over strict histories
        of moment values (\S\ref{appendix:evaluate-histories}) matches 
    ...
    \subsection{Proofs of corollaries}                              \label{appendix:corollaries}
        ...
        \subsubsection{Corollary \ref{cor:entropic}}
            ...
            \begin{proof}
                ...
                An history of this diagram into $E=B=1$ SGD's grid 
        ...
        \subsubsection{Corollary \ref{cor:overfit}'s first part}
            ...
            \begin{proof}[Proof.]
                ...
                minimum).  This diagram has one history for each pair of
