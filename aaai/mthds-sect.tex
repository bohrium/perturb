    ...
    \subsection{What image-classifying landscapes did we use?}   \label{appendix:natural}
    ...
    \subsection{Software frameworks and hardware}                   \label{appendix:frameworks}
        ...
        by random seeds (in our experiments $0, 1729$) and hence reproducible.
        %
