...
\begin{abstract}
    ...
    scattering events, thus offering a new physical analogy for descent.
    Illustrating this technique, we construct a regularizing term that causes
    large-batch GD to emulate small-batch SGD, exhibit a counter-intuitive loss
    landscape on which SGD eternally moves uphill despite well-behaved boundary
    conditions and zero curvature in the direction of motion, and quantify the 
    differences --- due to time-discretization, inter-epoch correlations, and
    non-gaussian noise --- between SGD and the popular approximation SDE. 
\end{abstract}
...
\section{Experiments and Applications}
    ...
    \subsection{Emulating Small Batches with Large Ones}
        ...
        \begin{figure}[h!]
            ...
            %\\
            %\plotplace{???}{0.48\columnwidth}{4.0cm}
