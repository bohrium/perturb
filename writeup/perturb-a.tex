...
\subsection{Descent as Scattering}
    ...
    \begin{figure}[h!]
        \centering
        \plotmoo{diagrams/spacetime}{4.0cm}{4.0cm} 
        ...
        \caption{
            {\bf a} Some diagrams embedded in pure GD's spacetime.  Top three
                    give order $\eta^3$, $\eta^5$, and $\eta^1$ contributions.
                    Bottom three all give identical order $\eta^2$
                    contributions to test loss, including the bottom-most,
