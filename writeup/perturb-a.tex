...
\end{document}
    ...
    %\begin{figure}[h!]
    %    \centering
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-lenet-07-poly}
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-lenet-long-06-ode} \\
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/gene-lenet-02-poly} 
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-loss-converged} \\
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-loss}
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/gen-gap}
    %    \caption{
    %        MNIST-10 LeNet mean losses vs $\eta$ for $T=100$.   Vertical
    ...
    %\begin{figure}[h!]
    %    \centering
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/model-selection-acc}
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/model-selection-loss} \\
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/batchmatch-06} 
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-loss} \\
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-loss} 
    %    \includegraphics[width=4.0cm, trim={0 0 0 1.0cm}, clip]{../plots/test-loss-bm}
    %    \caption{
