...
\section*{D. Diagram Rules vs Direct Perturbation}
    ...
    \subsection*{Effect of Batch Size}
        Let's compare the test losses of pure SGD and pure GD.  Because pure
        ...
        \end{align*}
        %In sum, the test loss of pure SGD to second order is  
        %\begin{align*}
        %    \expct{l}
        %    &- \eta   MN \expct{\nabla l}^2 \\
        %    &+ \eta^2 N^2M (N-1) \expct{\nabla l} \expct{\nabla^2 l} \expct{\nabla l} \\
        %    &+ \eta^2 M^2N       \expct{\nabla l} \expct{(\nabla^2 l)(\nabla l)} \\
        %    &+ \eta^2 M^2N (N-1) \frac{1}{2} \expct{\nabla^2 l} \expct{\nabla l}^2 \\
        %    &+ \eta^2 M^2N       \frac{1}{2} \expct{\nabla^2 l} \expct{(\nabla l)^2}
        %     + o(\eta^2)
        %\end{align*}
    ...
    \subsection*{Effect of Nongaussian Noise}
