...
\subsection{Recipe for the Test Loss of SGD}
    Our results all follow from the next theorem and its close analogues:
    \begin{thm}
    ...
    \begin{cor}
        ...
        $
            \frac{T^2 N^{-1}}{2} \wrap{\sdia{(01-2)(02-12)}-\sdia{(0-1-2)(02-12)}}
        $.
        The order $N^{-2}$ deviation of SGD's test loss due to non-gaussian
        noise is
        $
            \frac{T^3 N^{-2}}{6} \wrap{\sdia{(012-3)(03-13-23)} - 3 \sdia{(01-2-3)(03-13-23)} + 2 \sdia{(0-1-2-3)(03-13-23)}}
        $.
    \end{cor}
    ...
    \begin{prop}
        ...
        \begin{align*}
                                                          \dia{(0)()}
            &-  MN                                         \dia{(0-1)(01)}
             + MN\wrap{M(N-1) - \frac{1-\frac{1}{B}}{2}}  \dia{(0-1-2)(01-12)} \\
            &+ MN\wrap{\frac{M}{2}}                       \dia{(01-2)(02-12)}  
             + MN\wrap{\frac{M-\frac{1}{B}}{2}}           \dia{(01-2)(01-12)}
        \end{align*}
        }
    \end{prop}
    ...
    \begin{cor}
        ...
        $$
              \frac{M(N-1)}{2N} (\dia{(01-2)(01-12)} - \dia{(0-1-2)(01-12)})
        $$
        Moreover, GD on a modified loss 
        $$
            \tilde l_n = l_n + \frac{N-1}{4N^2} \hat{C}_\nu^\nu(\theta)
        $$
        has an expected test loss that agrees with SGD's to second order.
        Here, $\hat{C}$ is any unbiased estimator of gradient covariance.
    \end{cor}
