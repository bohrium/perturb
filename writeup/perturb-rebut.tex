...
\begin{abstract}
    ...
    Illustrating this technique:
        We construct a regularizer causing large-batch GD to emulate
        small-batch SGD.
        %
        We exhibit a non-conservative entropic force driving SGD.
        %
        We generalize the Akaike Info.\ Criterion (AIC) to a smooth
        quantity liable to descent.
        %
        We quantify how SGD differs from the popular approximation
        SDE. 
    %
...
\section{Insights from the Formalism}
    ...
    \subsection{SGD descends on a $C$-smoothed landscape}
        ...
        the velocity field above need not be conservative (see Experiments).
