...
\section{Introduction}
    ...
    Our underlying formalism is especially novel: we
    ...
    \subsection{Overview of Approach}
        ...
        \ref{thm:renorm} to find $T$ so large large that SGD senses curvature
...
\section{Background and Notation} \label{sect:background}
    ...
    \subsection{Diagrams and Embeddings}
        ...
        \begin{defn}[Diagrams]
            ...
            This visual scheme echoes \citet{fe49, pe71}.
        \end{defn}
        ...
        \begin{defn}[Evaluating a Diagram]
            ...
            $$
            We write $\dvalue(D)$ for a diagram's value, or just $D$ when clear.
        \end{defn}
    ...
    \subsection{Recipe for SGD's Test Loss and Generalization}
        ...
        \begin{prop}[Specialization to Vanilla SGD] \label{prop:vanilla}
            ...
            \begin{equation*}\label{eq:sgdbasiccoef}
                ...
                \dvalue(D)
            \end{equation*}
            where $D$ ranges over $d$-edged diagrams each of whose parts does
            not contain any of its nodes' ancestors.  Here, $D$'s parts have
            sizes $d_p: 0\leq p\leq P$, with $d_P=1$.  each antichains.  The
            modification to compute the generalization gap is the same as in
            Theorem \ref{thm:sgdcoef}.
        \end{prop}
