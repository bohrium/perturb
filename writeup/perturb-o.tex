...
\addtolength{\textfloatsep}{-8mm}
\addtolength{\dbltextfloatsep}{-8mm}
...
\section{Diagram Calculus for SGD} \label{sect:calculus}
    ...
    \subsection{Effective Theories} \label{subsect:effective}
        ...
        \begin{figure}[h!]
            \centering
            \plotmooh{diagrams/entropic-force-diagram}{}{0.31\columnwidth} 
...
\section{Experiments}
    ...
    Throughout, I-bars and +-marks denote a 95\% confidence interval of based
    ...
    \subsection{Emulating Small Batches with Large Ones}
        ...
        \begin{figure}[h!] 
            \centering
            \plotmoo{plots/new-test-0}{0.48\columnwidth}{3.0cm} 
            \plotmoo{plots/new-big-bm-new}{0.48\columnwidth}{4.0cm}
            \caption{
    ...
    \subsection{Sharp and Flat Minima Both Overfit Less} \label{subsect:overfit}
        ...
        \begin{figure}[h!] 
            \centering
            \plotmoo{plots/new-thermo-linear-screw}{0.48\columnwidth}{4.0cm}
            \plotmoo{plots/new-tak}{0.48\columnwidth}{4.0cm}
            \caption{
        ...
        noisy, small-$N$ regime.  In fact, we find that this analysis leads to
