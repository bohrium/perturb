...
\section{Introduction}
    %\subsection{Overview}
        ...
        by a Feynman diagram.  When $\eta$ is small, only a handful of diagrams
        substantively contribute, and our formalism permits concrete
        computation.
        ...
        tool for optimization theorists.  The corollaries we here present are
        ...
        %As individual Feynman diagrams \citep{fe49}
        ...
        %before affecting a final test loss.
    ...
    \subsection{Appetizing Example: Role of Epoch Number}
            ...
            test losses of one- and multi-epoch SGD to order $\eta^2$.  Here,
            we scale $M$-epoch SGD's learning rate by $1/M$.
            ...
            those embeddings contribute the same amount to one- and to
            multi-epoch SGD, we may neglect them as we compute the SGDs'
            difference.  Only the diagram $\sdia{c(01-2)(01-12)}$ has
            embeddings in multi-epoch SGD that do not correspond to embeddings
            in one-epoch SGD (Figure \ref{fig:epoch}). 
...
\section{Background and Notation} \label{sect:background}
    ...
    \subsection{Tensor Conventions}
        We fix a loss landscape throughout the paper. 
    ...
    \subsection{SGD Terminology}
        ...
        \emph{datapoint}, and the estimates together form the \emph{train set}.
...
\section{Conclusion}
    ...
    SGD, and that they offer an elegant and streamlined calculation framrwork
    for making those predictions.  Our Renormalization Theorem licences
    ...
    using diagrams.  The theory makes many predictions:
