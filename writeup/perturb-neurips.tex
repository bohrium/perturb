...
\section{Assumptions, results, proofs, and future topics}
    ...
    \subsection{A key lemma \`a la Dyson}                           \label{appendix:key-lemma}
        ...
        function equal to the $d_t$th derivative of $f$, scaled by $g$.  The
        above product then indicates composition of $g \nabla^{d_t}$'s
