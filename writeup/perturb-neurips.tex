...
\section{How to calculate test losses: a practical guide}\label{appendix:tutorial}
    ...
    \subsection{An example calculation: the effect of epochs}       \label{appendix:example}
        ...
        \end{quest}
        To make our discussion concrete, we will set $M_0=2$, but our analysis 
        ...
        \subsubsection*{Embeddings of diagrams into space-time}
            ...
            $\sdia{(0-1-2)(02-12)}$ embeds similarly into multi-epoch
            and single-epoch spacetimes.  More precisely,
            its multi-epoch embeddings correspond by a $2^2:1$ map to
            its single-epoch embeddings.
