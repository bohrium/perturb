...
\section{Introduction}
    ...
    \subsection{Example of diagram-based computation of SGD's test loss} \label{subsect:example}
        ...
        Deferring details, we illustrate the Main Idea.  This shows our
        formalism's work flow, but only in later sections will we explain the
        mathematics.

        First, let $l_x(\theta)$ be weight
        $\theta$'s loss on datapoint $x$.  We define a dictionary between
        tensors relating to this loss landscape, and diagram fragments that we
        will soon assemble:
        \begin{center}
            \begin{tabular}{ll}
        ...
        \begin{rmk}
            ...
            curvature.
            Gaussian approximations (e.g.\ SDE) miss this effect. 
        \end{rmk}
...
\subsection{Background, notation, and assumptions} \label{sect:background}
    ...
    %\subsection{Tensor conventions}
        ...
        $\eta$ to raise indices; for example,
        $
            H^{\mu}_{\lambda}
            \triangleq
            \sum_{\nu} 
...
\section*{Acknowledgements}
    ...
    %\begin{ack}
        ...
        their patient guidance.  We appreciate the time that
