...
\section{How to calculate test losses}                   \label{appendix:tutorial}
    ...
    \subsection{How to identify the relevant diagram embeddings}    \label{appendix:draw-embeddings}
        ...
        Table \ref{tab:scatthree} shows the $6$ diagrams that may embed into
        the space-time grid of $E=B=1$.  It shows each diagram in multiple
        ways to underscore that diagrams are purely topological and to suggest
        the ways in which these diagrams may embed into space-time.
        \begin{table}[h!]
            \centering 
            ...
            \begin{tabular}{ccccc}
                ...
                \begin{tabular}{c}
                    \begin{tabular}{LL}
                        \bdia{c(0-1-2-3)(01-12-23)} & \bdia{c(0-1-2-3)(01-13-23)}
                    \end{tabular} \\
                    \begin{tabular}{LL}
                        \bdia{c(0-1-2-3)(02-13-23)} & \bdia{c(0-1-2-3)(03-12-23)}
                    \end{tabular} \\ \hline
                    \begin{tabular}{LL}
                        \bdia{c(0-1-2-3)(03-13-23)} & \bdia{c(0-1-2-3)(02-12-23)}
                    \end{tabular}
                \end{tabular}
                &&
                \begin{tabular}{c}
                    \begin{tabular}{LL}
                        \bdia{c(01-2-3)(02-13-23)} & \bdia{c(01-2-3)(03-12-23)}
                    \end{tabular} \\ \hline
                    \begin{tabular}{LL}
                        \bdia{c(0-12-3)(01-13-23)} & \bdia{c(0-12-3)(02-13-23)}
                    \end{tabular} \\ \hline
                    \begin{tabular}{LLL}
                        \bdia{c(01-2-3)(03-13-23)} & \bdia{c(0-12-3)(03-13-23)} & \bdia{c(01-2-3)(02-12-23)} 
                    \end{tabular}
                \end{tabular}
                &&
                \begin{tabular}{c}
                    \begin{tabular}{L}
                        \bdia{c(012-3)(03-13-23)}
                    \end{tabular}
                \end{tabular}
            \end{tabular}
            }
