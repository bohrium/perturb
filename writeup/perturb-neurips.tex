...
\section{Experiments}
    ...
    \subsection{Training time, epochs, and batch size; $C$ repels SGD more than GD}
        ...
        \begin{figure}[h!] 
            \centering
            \pmoo{3.4cm}{new-test-0}        \pmoo{3.4cm}{new-big-bm-new}          \pmoo{3.4cm}{neurips-thermo-linear-screw}
            \pmoo{3.4cm}{rebut-test-1-T100} \pmoo{3.4cm}{neurips-gen-cifar-lenet} \pmoo{3.4cm}{new-tak}
            \caption{
