...
\section{Experiments}
    ...
    \subsection{Minima that are flat \emph{with respect to} $C$ attract SGD}
        ...
        its valley of global minima.  Figure \ref{fig:landscapes} intuitively
        depicts \Archimedes' mechanism.\footnote{We made these plots with the
        help of Paul Seeburger's online applet, \emph{CalcPlot3D}.}  As in
        ...
        %
        Because SGD's motion depends smoothly on the landscape, the
        special case of \Archimedes\ establishes that non-conservativity is
        generic.  That is, SGD's macroscopic motion cannot be characterized
        as descending on any metric. 
        %
