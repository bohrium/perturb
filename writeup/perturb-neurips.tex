...
\section{Experiments}
    ...
    \subsection{Training time, epochs, and batch size; $C$ repels SGD more than GD}
        ...
        \begin{figure}[h!] 
            \centering
            \pmoo{3.55cm}{new-test-0}          \pmoo{3.55cm}{new-big-bm-new}          \pmoo{3.55cm}{neurips-thermo-linear-screw}
            \pmoo{3.55cm}{neurips-test-1-T100} \pmoo{3.55cm}{neurips-gen-cifar-lenet} \pmoo{3.55cm}{new-tak}
            \caption{
    ...
    \subsection{Minima that are flat \emph{with respect to} $C$ attract SGD}
        ...
        \begin{wrapfigure}[17]{r}{0.48\textwidth} 
            ...
            \caption{
                ...
                surface.  Due to anisotropic noise, $\theta$ scatters away from
