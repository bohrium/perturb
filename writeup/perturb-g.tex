...
\section{Introduction}
    ...
    \subsection{Appetizing Example: Role of Epoch Number}
            ...
            key role.  While diagrams may by direct use of our Key Lemma be
            completely avoided, Appendix \ref{sect:compare} shows that to avoid
            them can convolute analysis.  The more complicated the direct
...
\section{Diagram Calculus for SGD} \label{sect:calculus}
    ...
    \subsection{Recipe for SGD's Test Loss and Generalization}
        We prove the following in Appendix \ref{sect:proofs}.
...
\section{Conclusion} \label{sect:concl}
    ...
    The theory makes many novel predictions:
