...
\section{Introduction}
    ...
    \subsection{Example of diagram-based reasoning}
        ...
        %we present a sample computation.
        %to illustrate how, by
        ...
        \begin{table}[h]\centering
            ...
            \caption{
                ...
                %
                Each $l_x$ corresponds to a node, each $\nabla$ corresponds to
                a thin edge, and fuzzy outlines connect nodes that occur within
        ...
        \begin{rmk}
            ...
            %Section {\color{red} FILL IN} defines this correspondence.  
