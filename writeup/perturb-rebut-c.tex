...
\section{Introduction}
    ...
    \subsection{Overview of Approach}
        ...
        %Embeddings of $\sdia{(01-2)(01-12)}$, $\sdia{(01-2)(01-12)}$,
        %$\sdia{(0-1-2)(01-12)}$.  First embedding violates $t<t^\prime$ rule
        %for edges. 

        %shuffling.  Interpreting an order $\eta^4$ diagram.
...
\section{Diagram Calculus for SGD} \label{sect:calculus}
    ...
    \subsection{Recipe for SGD's Test Loss and Generalization}
        ...
        Table \ref{tab:scatthree} shows the $6$ order-$3$ diagrams as well as
        $(4+2)+(2+2+3)+(1)$ total orderings relevant to the Proposition.
        %\end{exm}
        ...
        \begin{table}[H]
            ...
            \caption{
                ...
                {\bf Left:} $(d, f) = (3, 0)$.  Diagrams for ODE behavior.
                {\bf Center:} $(d, f) = (3, 1)$.  $1$st order deviation of SGD
                away from ODE.
                {\bf Right:} $(d, f) = (3, 2)$.  $2$nd order deviation of SGD
    ...
    %    \end{cor}
    %
    %    \begin{cor}[An Entropic Force, Unre-summed] \label{cor:noncons}
    ...
    %    methods reproduce it elegantly.  We will re-sum it to Corollary
    ...
    \subsection{Effective Theories} \label{subsect:effective}
        ...
        %    \caption{
        %        {\bf Re-summation summarizes Hessians' long-term effect.}
        %        {\bf Left}:
        %            Some contributions to $\rvalue_f(\sdia{(0-1)(01)})$ for an
        %            example embedding $f$.  Theorem \ref{thm:resum} shows how
        ...
        %            and implicit in Theorem \ref{thm:resum}.
        %    }
        %    \label{fig:resumspacetime}
        %\end{figure}
...
\section{Experiments}
    ...
    \subsection{Sharp and Flat Minima Both Overfit Less} \label{subsect:overfit}
        ...
        \begin{figure}[h!] 
            ...
            \caption{
                {\bf Re-summed predictions excel even for large $\eta T$.}
...
\section{Conclusion} \label{sect:concl}
    ...
    small-$\eta T$ SGD.  In fact, our Re-summation Theorem licences
