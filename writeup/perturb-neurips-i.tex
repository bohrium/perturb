        ...
        \subsubsection{High-$C$ regions repel small-$(E,B)$ SGD more than large-$(E,B)$ SGD}
            ...
            This mechanism parallels the Chladni effect \cite{ch87}
             (Figure \ref{fig:chladni}).\footnote{
                ...
                \url{dataphys.org}, Creative Commons BY-SA 3.0. 
            }
            %
            ...
            \begin{cor}[$\sdia{c(01-2)(01-12)}$] \label{cor:epochs}
                ...
                than SGD with $M=M_0$ and $\eta=\eta_0/M_0$:
                $
    ...
    \subsection{Minima that are flat \emph{with respect to} $C$ attract SGD}
        ...
        \begin{wrapfigure}[17]{r}{0.48\textwidth} 
            ...
            \caption{
                ...
                Green sheet: a level surface of $l$ with a valley of minima
                ($z$ axis) at its center; $l$ is large outside this surface.
                Magenta tubes: typical $\theta$s due to non-isotropic noise.
                %
                \textbf{Left}: $z$ axis points into the page.  \textbf{Right}:
        ...
        depicts \Archimedes' chiral shape.\footnote{We made these plots with
        the help of Paul Seeburger's online applet, \emph{CalcPlot3D}.}  As in
