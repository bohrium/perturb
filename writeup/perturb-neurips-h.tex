...
\section{Introduction}
    ...
    the body of theory on \emph{optimization in the face of uncertainty},
...
\section{Theory, specialized to $E=B=1$ SGD's test loss} \label{sect:calculus}
    ...
    %\subsection{Diagrams, embeddings, and re-summed values}
        ...
        corresponding sequence of times is increasing.  For instance, $f$ might send
    ...
    \subsection{Insights from the formalism}
        ...
        \subsubsection{High-$C$ regions repel small-$(E,B)$ SGD more than large-$(E,B)$ SGD}
            ...
            Physical intuition suggests that gradient noise is repulsive
            \cite{ch87}.  Indeed:
    ...
    \subsubsection{Training time, epochs, and batch size; $C$ repels SGD more than GD}
        ...
        \begin{figure}[h!] 
            ...
            \caption{
                ...
                special of \Archimedes\ establishes that non-conservativity is
                generic.    
                %
                ...
                Near $H=0$, we improve on Takeuchi information \citep{di18} and
                hence on AIC.
            }
            \label{fig:vanilla}
...
\section*{Broader impacts}
    ...
    perhaps we it is not efficiency we should seek, but rather delight,
    surprise, and beauty.
