...
\section{Introduction}
    %\subsection{Overview}
        ...
        tests on convolutional networks for CIFAR-10 and Fashion-MNIST.
...
\section{Experiments and Applications}
    ...
    \subsection{Comparison to Continuous Time}
        ...
        shows that, indeed, SDE and single-epoch SGD differ.  For multi-epoch
...
\section{Tutorial on Diagram Rules} \label{sect:tutorial}
    ...
    \subsection{Listing Relevant Diagrams}
        ...
        \subsubsection*{Review of Rules}
            ...
            loss), the optimization schedule (single-epoch / effect of batch
