...
\section{Diagram Calculus for SGD} \label{sect:calculus}
    ...
    \subsection{How Diagrams Arise}
        ...
        \begin{defn}[Fuzzy Outlines Denote the Effect of Noise]
            We'd like to concisely notate the effect of correlations.
    ...
    \subsection{Effective Theories} \label{subsect:effective}
        ...
        Integrating $\rvalue{\sdia{(01-2-3)(02-12-23)}}$ yields:
        ...
        Integrating $\rvalue{\sdia{(01-2)(02-12)}}$ and
        $\rvalue{\sdia{(01)(01)}}$ yields:
...
\section{Experiments and Applications}
    ...
    Due to arbitrary choices of architecture and optimization duration, metrics
    such as mean squared error mean little as we compare our predictions to
    measured test losses.  Instead, we focus on experiments whose rejection of
    the null hypothesis (and hence support of our theory) is so drastic as
    to be visually obvious.  For example, in Figure \ref{fig:thermo},
    ...
    \subsection{Basic Predictions}
        ...
        up to $\eta T \approx 10^0$ (figures in Appendix \ref{sect:figures}).
        Likewise, Corollary \ref{cor:epochs} predictions about epochs agree
        with experiment (Figure \ref{fig:bmmulti}).  These tests verify that
        our application of the diagram method hides no mistakes of
        proportionality or sign.  

        {\color{moor} FILL IN TABLE!}
...
{\colorbox{moopink}{\color{mooteal}acknowledgements commented}}
