...
\section{Diagram Calculus for SGD} \label{sect:calculus}
    ...
    \subsection{How Diagrams Arise}
        ...
        equalities by fuzzy ties\footnote{This visual schema echoes \citet{fe49, pe71}.}.
        Thus arise diagrams.
    ...
    \subsection{Effective Theories} \label{subsect:effective}
        ...
        $\Delta t$, this series of diagrams sums to contributes
        $
...
\section{Tutorial on Diagram Rules} \label{sect:tutorial}
    ...
    \subsection{
        Overfitting and Generalization of GD.  Proof of Corollary
        \ref{cor:overfit}. 
    }
    ...
    \subsection{
        ...
        \subsubsection*{Un-renormalized}
            ...
            {\color{moob}red} nodes and the
            {\color{moob}green} node, respectively.  The result follows.
        ...
        \subsubsection*{Renormalized}
            ...
            $t$ from {\color{moob}red} to {\color{moob}green} and
            $\tilde t$ from {\color{moob}green} to {\color{moob}blue},
            such that $t+\tilde t \leq T$
            The automorphism group of every embedding has size $2$: identity
            or switch the {\color{moob}red} nodes.  So the answer is: 
            $$
                C_{\mu \nu}
                J^{\rho\lambda}_{\sigma}
    ...
    \subsection{
        SGD vs ODE.
        Proof of Corollary \ref{cor:vsode}'s First Part
    }
