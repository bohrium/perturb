...
\section*{Invitation to Appendices}
    ...
    %
    \textsc{Appendix} \ref{sect:glossary} roughly defines physical and mathematical
        terms we use and includes a table of values and interpretations for
        diagrams.
...
\section{Tutorial on Diagram Rules} \label{sect:tutorial}
    ...
    Remember the computational recipe.  To compute a quantity of interest, list
    ...
    process.  The material is slightly nonlinear, so we present it redundantly.
    ...
    \subsection{
        ...
        Proof of Corollaries \ref{cor:} and \ref{cor:}. 
    }
        {\color{moor} FILL IN}
    ...
    \subsection{
        ...
        Proof of Proposition \ref{prop:} and Corollary \ref{cor:}. 
    }
        {\color{moor} FILL IN}
