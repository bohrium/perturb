...
\section{Introduction}
    %\subsection{Overview}
        ...
        theory.  As applications of the theory, we find:
        ...
        comparable to $(\eta T)^{-1}$.  While flat minima are robust to
        vector-valued weight displacements and sharp minima are robust to
        covector-valued loss offsets, medium minima attain the worst of both
        worlds.  We thus reconcile prior intuitions that sharp \citep{ho17,
        ke17, wa18} or flat \citep{st56, di17, wu18} minima overfit worse.  These
...
\section{Background and Notation}
    ...
    \subsection{Tensor Conventions}
        ...
        hold for $\tanh$ neural networks with cross entropy
        loss on bounded data --- and with arbitrary weight sharing, skip
        connections, soft attention, dropout,
        %batch normalization\footnote{
        %    assuming batches remain disjoint throughout training so that each
        %    batch may be considered as a single datapoint in a
        %    higher-dimensional space 
        %}
        and weight decay.  Since our work does not rely on
        information-geometric relationships between $C$ and $H$ \citep{am98},
    ...
    \subsection{SGD Conventions and Terminology}
