...
\section{Introduction}
    ...
    by theory about optimization in the face of
...
\section{Diagram Calculus: Formalism and Corollaries} \label{sect:calculus}
    ...
    \subsection{Insights from the Formalism}
        ...
        \subsubsection{SGD descends on a $C$-smoothed landscape}
...
\section{Experiments}
    ...
    Appendix \ref{sect:landscape} lists architectures and sample sizes.
