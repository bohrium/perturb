...
def draw(filename): 
    ...
    draw_diagram(img, [[(1, 5    ),                 (0.5    , 8    )], 
                       [            (0, 6),         (0.5    , 8    )]])
    draw_diagram(img, [[(1, 4    ), (2, 6),         (1.5    , 8    )]])
    draw_diagram(img, [[(3, 0    ), (1, 3),         (2.5    , 8    )]])
...
draw.text((get_c(0.18), get_r(8+0.7)), "Space Time for Pure GD and Pure SGD", font=fnt, fill=(0,0,0,255))
for t in range(T):
