...
#colors = [red, blue, green, black, green, blue, gold, black, black]
...
for outline in [False, True]:
    for pp, gg in (
        ...
        #([[0], [1], [2]], [[0,1],[0,2],[1,2]]),
        #([[0], [1], [2]], [[0,2]]),
        #([[0,2],[0,1,2],[3]], [[0,2],[1,2],[2,3]]),
        #([[0,3],[1,2],[4]], [[0,3],[1,3],[2,3],[3,4]]),
        #
        #([[0],[1],[2],[3],[4]],[[0,1],[1,2],[2,3],[3,4]]),
        #([[0,2],[1],[3],[4]],[[0,1],[1,4],[2,3],[3,4]]),
        #([[0,3],[1],[2],[4]],[[0,1],[1,2],[2,4],[3,4]]),
        #
        #([[0],[1,2,3],[4]], [[0,1], [1,4], [3,4], [2,4]]),
        #
        #([[0],[1]],[[0,1], [1]]),
        #([[0],[1],[2]],[[0,1], [1,2],[2]]),
        ##
        ##
        #([[0,1],[2],[3],[4]],[[0,2], [1,2],[2,3], [3,4]]),
        ([[0,1],[2,3],[4]],[[0,3], [1,3],[2,3], [3,4]]),
        ([[0,2],[1,3],[4]],[[0,3], [1,3],[2,3], [3,4]]),
    ):
