...
\begin{document}
    ...
    \section{Perturbative theory of SGD}
        ...
        \subsection{Trivial example: an exegesis of Proposition \ref{prop:nest}}
            ...
            \begin{proof} (of Proposition \ref{prop:nest}).
                ...
                $\sum_{n\in \Bb_t} l_n(\theta) / B$.  Applying the induction
                hypothesis proves the claim.
                %
                Finally, we plug the claim into a Taylor expansion of $l$ (by
                the moment assumptions of \S\ref{appendix:assumptions},
                expectations of the $o(\eta^1)$ are still $o(\eta^1)$):
                \begin{align*}
                    \expc[l(\theta_T) - l(\theta_0)]
                    &= \nabla l(\theta_0) \cdot \expc[\theta_T - \theta_0] + o(\theta_T - \theta_0) \\
            ...
            -- transparency / degree boundedness

            -- combinatorial explosion: where noise and curvature come in 

            -- always get a polynomial in T
