...
\begin{document}
    ...
    \section{Perturbative theory of SGD}
        ...
        \subsection{Using diagrams}
            ...
            \begin{samepage}
            We interpret edges as carrying influence from the
    ...
    \section{Conclusion}
        ...
        together illuminate SGD's success in training deep networks:
        SGD avoids curvature and noise, and curvature and noise control
        generalization.
