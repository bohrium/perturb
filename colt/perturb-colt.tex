...
\begin{document}
    ...
    \section{Experiments}
        ...
        than GD}
            ...
            \begin{figure}[h!] 
                ...
                \caption{
                    ...
                    %%%
                    %%%
                    \newline {\bf Center: $C$ controls generalization gap.}%.and distinguishes GD from SGD.}
                    %
        ...
        \subsection{Minima that are flat \emph{with respect to} $C$ attract SGD}
            ...
            discrete translation symmetry in that direction.  We may wrap \Helix\ 
            in a loop to make SGD perpetually
            circulate and in particular to witness a non-conservative velocity
            field (\S\ref{appendix:artificial}).
    ...
    \section{Conclusion}
        ...
        \subsection{Related work}\label{sect:related}
            ...
            Some analyses of optimization's implicit regularization use an SDE
            approximation (e.g.\ \cite{ch18}), but, per \cite{ya19a}, such
            continuous-time analyses treat SGD noise incorrectly.
            %
