...
\begin{document}
    ...
    \section{Perturbative theory of SGD}
        ...
        \subsection{Introducing diagrams}\label{sect:diagrams}
            ...
            ancestor-descendant pair in the same part contributes zero.  The
            $t^d T^{-p}$-th order correction\footnote{We compare ODE integrated
            to time $t$ to $T$ steps of SGD with $\eta = \eta_\star t/T$ and
            $E=B=1$, and we assume $p\neq 0$.} to the ordinary differential
            equation approximation of SGD is given by diagrams with $d$ edges
            and $p$ many gray ties.  For SGD initialized at a minimum of $l$,
        ...
        \subsection{Using diagrams}
            ...
            As discussed in the next section, explained
