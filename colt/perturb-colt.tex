...
\begin{document}
    ...
    \section{Perturbative theory of SGD}\label{sect:calculus}
        ...
        \subsection{Challenges when using Taylor series to study SGD}\label{sect:exegesis}
            ...
            $\theta_T$ no matter the value of $T>t$ (indeed, in the
        ...
        \subsection{Diagrams arise from Taylor series and depict information-flow processes}\label{sect:diagrams}
            ...
            diagrams to generalize \S\ref{sect:exegesis}'s transparency, tame
        ...
        \subsection{Diagrams overcome the challenges of using Taylor series to study SGD}\label{sect:using}
            ...
            the uvalues of chains are powers of hessians --- for example,
            ...
            \begin{dfn}\label{dfn:link}
                ...
                participates in no gray ties.  To \emph{reduce} at a link, we
