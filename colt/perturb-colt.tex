...
\begin{document}
    ...
    \section{Introduction}
        ...
        \subsection{Related work}\label{sect:related}
            ...
            architecture.  E.g.\ we assume no information-geometric
    ...
    \section{Perturbative theory of SGD}
        ...
        \subsection{Discussion of a trivial example}\label{sect:exegesis}
            ...
            ``\emph{translucence}'': we find that a term that involves updates
        ...
        \subsection{Introducing diagrams}\label{sect:diagrams}
            ...
            There are dozens of small diagrams.  In many analyses, all
            but a few diagrams will be irrelevant.
            Most importantly: for fixed $T$, \textbf{to order $\eta^d$ we may
            neglect all diagrams with more than $d$ edges}.
            %
            Other examples: if $E=B=1$, then a diagram with an
            ancestor-descendant pair in the same part contributes zero.    For SGD initialized at a minimum of $l$,
            all diagrams vanish that contain a leaf participating in no gray
            tie.
        ...
        \subsection{Using diagrams}
            ...
            \end{dfn}
            \begin{prop}[Key Lemma, restated] %\label{thm:pathint}
            ...
            This restatement streamlines analysis of SGD.  
            For example, we may
            ...
            \end{wrapfigure}
                ...
                As another example, since a diagram's uvalue depends only on its
                graph and partition structures (and not on its root), we have
                relations such as\footnote{The physics-oriented reader will recognize this as a
                \emph{crossing symmetry}.}
                $$\uvalue(\sdia{c(0-1-2)(01-12)})=
                \uvalue(\sdia{c(0-1-2)(02-12)})$$ 
                These relations reduce the effort of evaluating (\ref{eq:dyson}).
                They also are theoretically interesting, for they relate
                the contribution of a process (such as $\sdia{c(0-1-2)(01-12)}$,
                whose degree-two node is temporally between its neighbors) to a version of the
                process distorted by time travel (such as $\sdia{c(0-1-2)(02-12)}$,
                whose degree-two node temporally follows its neighbors). 
            ...
            the training set toward the test measurement.  
            ...
            %While \S\ref{appendix:future} discusses bridges to physics and
            %relations to Hessian methods and natural GD, this section
            %discusses how t
    ...
    \section{Experiments}
        ...
        \subsection{Minima that are flat \emph{with respect to} $C$ attract SGD}
            ...
            constructs a landscape, \Helix on whose valley of global minima $C$
            varies.  Figure \ref{fig:archimedes} depicts \Helix' chiral
            shape.\footnote{
            ...
            discrete translation symmetry in that direction.
    ...
    \section{Conclusion}
        ...
        This paper provides a new perspective on SGD. 
