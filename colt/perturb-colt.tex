...
\begin{document}
    ...
    \section{Perturbative theory of SGD}\label{sect:calculus}
        ...
        \subsection{Diagrams arise from Taylor series and depict information-flow processes}\label{sect:diagrams}
            ...
            \end{align*}
            We thus associate tensors with diagrams.\footnote{
        ...
        \subsection{Diagrams overcome the challenges of using Taylor series to study SGD}\label{sect:using}
            ...
            \begin{dfn}
                A \textbf{link} is a degree-$2$ non-root node that participates in
            ...
            \noindent
            We will express in closed form the total
            contribution to (\ref{eq:dyson}) of all diagrams in such a
            list.  This is the \emph{resummed value} of the list's unique
            linkless member.
            %
            The idea is that the uvalues of chains are powers of
            ...
            series.
            %
            We thus define the \textbf{rvalue} of an embedded diagram 
        ...
        \subsection{Main result}\label{sect:main}
            ...
            \begin{rmk} \label{rmk:integrate}
                \emph{In practice, we approximate sums over embeddings by integrals
                over times and $(I-\eta H)^t$ by $\exp(- \eta H t)$, reducing
                to a routine integration of exponentials at the cost of an
                error factor $1 + o(\eta)$ --- and thus preserving leading-order results.}
            \end{rmk}
