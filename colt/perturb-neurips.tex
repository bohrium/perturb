        ...
        \subsection{Non-Gaussian noise affects SGD but not SDE}
            ...
            \begin{cor}[$\sdia{c(01-2)(02-12)}$, $\sdia{c(012-3)(03-13-23)}$] \label{cor:vsode}
                ...
                $
                    ...
                    + o(\eta^3)
                $.\footnote{
                    This approximation of Example \ref{exm:first}'s more
                    exact expression agrees with the latter to leading order in
                    $\eta$.
                }
            \end{cor}
...
\section{How to calculate test losses}                   \label{appendix:tutorial}
    ...
    \subsection{Do diagrams streamline computation?}                \label{appendix:diagrams-streamline}
        ...
        \subsubsection{Effect of batch size}
            ...
            \subsubsubsection{Diagram Method}
            ...
            \newpage
            \subsubsubsection{Direct Perturbation} 
