...
\hspace{0.2cm}& of invalid diagrams \\ \hline\squash 
        ...
        \subsection{Main result}\label{sect:main}
            ...
            \begin{rmk}
                ...
                %
                %We take as a physically plausible and
                %empirically supported hypothesis that Thm \ref{thm:resum}
                %predicts SGD's behavior in the settings of
                %\S\ref{sect:consequences} for practical (finite but large) $T$s
                %and landscapes.}\mend
                %
                %
