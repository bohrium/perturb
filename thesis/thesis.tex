...
\chapter*{Organization of the appendices}
    ...
    contains our proofs.  Appendix C describes some tangential results not
    discovered during our research but disconnected from our main work.\\
    ...
    \par\indent     C.1 ~~ A new proof of the Chernoff bound                \hfill \pageref{appendix:chernoff}
